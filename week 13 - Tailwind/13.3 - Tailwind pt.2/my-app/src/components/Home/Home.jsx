...
const Home = () => {
    return (
        <div className="main-container flex text-white h-screen overflow-y-scroll">
            <Sidemenu />

            <div className="w-full bg-main-bg text-black relative">
                ...
                <div className="lg:h-[calc(100%-120px)] h-full grid grid-cols-1 new-br:grid-cols-7">  
                    ...
                    <div className="lg:col-span-2 h-full mx-auto">
                        <div className="profile h-90 w-64 -translate-y-8 bg-main-card rounded-xl flex justify-center p-2 items-center flex-col shadow-[0px_2px_7px_1px_rgba(0,_0,_0,_0.1)]">
                    ...
                    <div className="lg:col-span-3 h-full flex justify-center items-center flex-col bg-main-bg">
                    <p className="font-thin text-black/40 cursor-move">{"<---Swap--->"}</p>
                        <Carousel/>
                    </div>
                    <div className="lg:col-span-2 h-full grid place-items-center px-5 bg-main-bg">
                        <Menu/>
                    </div>
                </div>
            </div>
